  ...
  return (
    <View style={styles.itemContainer}>
      ...
      <View style={styles.rightItemsContainer}>
        ...
        <Text>
          <FontAwesomeIcon icon={faMapMarkerAlt} style={{color: 'grey'}} />{' '}
          {adress}
        </Text>
        <View style={styles.itemServices}>
          <Text style={{fontWeight: 'bold'}}>
            <FontAwesomeIcon icon={faBed} style={{color: 'grey'}} /> {rooms}
          </Text>
          <Text style={{fontWeight: 'bold'}}>
            <FontAwesomeIcon icon={faBath} style={{color: 'grey'}} />{' '}
            {bathrooms}
          </Text>
          <Text style={{fontWeight: 'bold'}}>
            <FontAwesomeIcon icon={faRuler} style={{color: 'grey'}} /> {area} ft
            ²
          </Text>
        </View>
